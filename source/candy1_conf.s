...
@;		16+:	gelatina doble (a sumarle código de elemento)
	...
	@; mapa 1: con secuencias horizontales y verticales
		.byte 1, 1, 1, 2, 4, 5, 1, 3, 6
		.byte 2, 4, 3, 3, 3, 6, 4, 5, 2
		.byte 6, 5, 6, 1, 1, 1, 3, 2, 4
		.byte 1, 1, 1, 4, 3, 5, 6, 1, 3
		.byte 2, 6, 3, 5, 2, 4, 6, 6, 6
		.byte 3, 2, 1, 3, 3, 3, 2, 5, 4
		.byte 4, 3, 4, 6, 5, 2, 4, 3, 1
		.byte 5, 5, 5, 1, 2, 6, 3, 1, 4
		.byte 6, 4, 2, 1, 6, 5, 6, 6, 6


	@; mapa 2: con bloques sólidos y huecos
	...
	@; mapa 3: con gelatinas simples y dobles
	...
	@; mapa 4: secuencias en los límites
